...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/artemprokudin/Downloads/BetaBeam/st_check/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/artemprokudin/Downloads/BetaBeam/st_check/venv/bin/deactivate.nu'
